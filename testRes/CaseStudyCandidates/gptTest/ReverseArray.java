...
public class ReverseArray {
    ...
    public void reverse() {
        ...
        {
            /*@ loop_invariant (\forall int j; j >= 0 && j < i; \old(a[a.length - (j + 1)]) == a[j] && \old(a[j]) == a[a.length - (j + 1)]) &&
    ...
    /*@ normal_behavior
      ...
      @ ensures (\forall int j; j >= 0 && j < p_a.length; b[j] == p_a[p_a.length - (j + 1)]);
      @*/
    public int[] reverse2(int[] p_a) {
        int[] b = new int[p_a.length];
        int i = 0;
        {
            /*@ loop_invariant i >= 0 && i <= p_a.length;
    ...
    public static void main(String[] args) {
        ...
        int[] reversedArray = ra.reverse2(ra.a);
