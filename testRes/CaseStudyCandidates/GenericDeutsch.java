package testRes.CaseStudyCandidates;
...
public class GenericDeutsch {
   ...
   */
    ...
    public boolean isBalanced(/*@ non_null */
        ...
        q_state_0 = new float[]{0.49999997F * oracle[0][0] + -0.49999997F * oracle[0][1] + 0.49999997F * oracle[0][2] + -0.49999997F * oracle[0][3], 0.49999997F * oracle[1][0] + -0.49999997F * oracle[1][1] + 0.49999997F * oracle[1][2] + -0.49999997F * oracle[1][3], 0.49999997F * oracle[2][0] + -0.49999997F * oracle[2][1] + 0.49999997F * oracle[2][2] + -0.49999997F * oracle[2][3], 0.49999997F * oracle[3][0] + -0.49999997F * oracle[3][1] + 0.49999997F * oracle[3][2] + -0.49999997F * oracle[3][3]};
        q_state_1 = new float[]{0.0F, 0.0F, 0.0F, 0.0F};
        {
            {
